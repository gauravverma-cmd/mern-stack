...
// dot ( . ) vs bracket [ ]
// dot used when the value is same or decleard in the object. For example => console.log(user.name)
// Bracket used when the value is not stored by the same name. For example => console.log(user[key]),where in code the object is like
...
// const key = "age";
// console.log(user[key]) // It shows the result 22 bcz key stores the value of age which is 22
